...
pub extern fn lua_rawlen(L: ?*lua_State, idx: c_int) usize;
...
pub extern fn lua_getuservalue(L: ?*lua_State, idx: c_int) c_int;
...
pub extern fn lua_setuservalue(L: ?*lua_State, idx: c_int) void;
...
pub extern fn lua_resume(L: ?*lua_State, from: ?*lua_State, narg: c_int) c_int;
...
pub extern fn luaopen_bit32(L: ?*lua_State) c_int;
...
pub const struct_luaL_Buffer = extern struct {
    ...
    initb: [8192]u8 = @import("std").mem.zeroes([8192]u8),
};
...
pub const LUAI_BITSINT = @as(c_int, 32);
...
// /usr/include/lua5.3/luaconf.h:447:9
pub const LUA_NUMBER = f64;
pub const l_mathlim = @compileError("unable to translate macro: undefined identifier `DBL_`");
// /usr/include/lua5.3/luaconf.h:490:9
...
// /usr/include/lua5.3/luaconf.h:499:9
...
// /usr/include/lua5.3/luaconf.h:680:9
...
pub const LUAL_BUFFERSIZE = @import("std").zig.c_translation.cast(c_int, (@as(c_int, 0x80) * @import("std").zig.c_translation.sizeof(?*anyopaque)) * @import("std").zig.c_translation.sizeof(lua_Integer));
...
pub const LUA_VERSION_MINOR = "3";
pub const LUA_VERSION_NUM = @as(c_int, 503);
...
pub const LUA_ERRGCMM = @as(c_int, 5);
pub const LUA_ERRERR = @as(c_int, 6);
...
pub const LUA_NUMTAGS = @as(c_int, 9);
...
// /usr/include/lua5.3/lauxlib.h:116:9
...
pub inline fn luaL_argcheck(L: anytype, cond: anytype, arg: anytype, extramsg: anytype) anyopaque {
    ...
    _ = &arg;
    _ = &extramsg;
    return @import("std").zig.c_translation.cast(anyopaque, (cond != 0) or (luaL_argerror(L, arg, extramsg) != 0));
}
